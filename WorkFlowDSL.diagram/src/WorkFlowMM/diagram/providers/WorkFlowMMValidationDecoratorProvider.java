 ...
 * @generated
 */
public class WorkFlowMMValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = WorkFlowMM.diagram.part.WorkFlowMMDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof WorkFlowMM.diagram.part.WorkFlowMMDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && WorkFlowMM.diagram.edit.parts.WorkFlowEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				WorkFlowMM.diagram.part.WorkFlowMMDiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
