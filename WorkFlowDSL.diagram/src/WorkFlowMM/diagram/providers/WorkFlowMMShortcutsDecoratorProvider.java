 ...
 * @generated
 */
public class WorkFlowMMShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = WorkFlowMM.diagram.part.WorkFlowMMDiagramEditorPlugin.getInstance()
