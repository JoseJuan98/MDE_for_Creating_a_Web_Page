 ...
 * @generated
 */
public class WorkFlowMMMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = WorkFlowMM.diagram.part.WorkFlowMMDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			WorkFlowMM.diagram.part.WorkFlowMMDiagramEditorUtil.selectElementsInDiagram(editor,
