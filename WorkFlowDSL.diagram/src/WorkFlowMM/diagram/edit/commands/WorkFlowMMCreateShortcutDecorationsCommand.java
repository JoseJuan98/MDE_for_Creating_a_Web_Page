 ...
 * @generated
 */
public class WorkFlowMMCreateShortcutDecorationsCommand extends AbstractTransactionalCommand {
	...
	* @generated
	*/
	public WorkFlowMMCreateShortcutDecorationsCommand(TransactionalEditingDomain editingDomain, View parentView,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put("modelID", WorkFlowMM.diagram.edit.parts.WorkFlowEditPart.MODEL_ID); //$NON-NLS-1$
