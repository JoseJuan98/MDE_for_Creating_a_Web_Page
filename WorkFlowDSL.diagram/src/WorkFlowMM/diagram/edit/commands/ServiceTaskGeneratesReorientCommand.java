 ...
 * @generated
 */
public class ServiceTaskGeneratesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ServiceTaskGeneratesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return WorkFlowMM.diagram.edit.policies.WorkFlowMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistServiceTaskGenerates_4003(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return WorkFlowMM.diagram.edit.policies.WorkFlowMMBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistServiceTaskGenerates_4003(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setGenerates(null);
		getNewSource().setGenerates(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setGenerates(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
