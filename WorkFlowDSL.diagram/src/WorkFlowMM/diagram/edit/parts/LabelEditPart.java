...
public class LabelEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WorkFlowMM.diagram.edit.policies.LabelItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WorkFlowMM.diagram.edit.parts.LabelIDEditPart) {
			((WorkFlowMM.diagram.edit.parts.LabelIDEditPart) childEditPart)
