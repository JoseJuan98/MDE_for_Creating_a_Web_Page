 ...
 * @generated
 */
public class SendMsgNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
				.getType(WorkFlowMM.diagram.edit.parts.SendMsgNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public SendMsgNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.SendMsg_3021, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new SendMsgLabelFigure();
	}

	/**
	* @generated
	*/
	public class SendMsgLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SendMsgLabelFigure() {
			this.setText("SendMsg");
		}
