	...
	*/
	static {
		registerSnapBackPosition(WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
				.getType(WorkFlowMM.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.ReceiveMsgAttachRec_4007, getParserElement(),
