 ...
 * @generated
 */
public class ReceiveMsgNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
				.getType(WorkFlowMM.diagram.edit.parts.ReceiveMsgNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	* @generated
	*/
	public ReceiveMsgNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.ReceiveMsg_3022, getParserElement(),
	...
	*/
	protected IFigure createFigurePrim() {
		return new ReceiveMsgLabelFigure();
	}

	/**
	* @generated
	*/
	public class ReceiveMsgLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ReceiveMsgLabelFigure() {
			this.setText("ReceiveMsg");
		}
