...
public class FileEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WorkFlowMM.diagram.edit.policies.FileItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WorkFlowMM.diagram.edit.parts.FileNameEditPart) {
			((WorkFlowMM.diagram.edit.parts.FileNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFileLabelFigure());
			return true;
		}
		return false;
	}
