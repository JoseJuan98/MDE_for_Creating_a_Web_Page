 ...
 * @generated
 */
public class DataGroupDataGroupDataCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public DataGroupDataGroupDataCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return WorkFlowMM.diagram.part.Messages.DataGroupDataGroupDataCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WorkFlowMM.diagram.edit.policies.DataGroupDataGroupDataCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new WorkFlowMM.diagram.edit.policies.DataGroupDataGroupDataCompartmentCanonicalEditPolicy());
	}
