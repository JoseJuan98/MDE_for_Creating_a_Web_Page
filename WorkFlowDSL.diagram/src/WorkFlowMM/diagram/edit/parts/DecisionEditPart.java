...
public class DecisionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WorkFlowMM.diagram.edit.policies.DecisionItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WorkFlowMM.diagram.edit.parts.DecisionIDEditPart) {
			((WorkFlowMM.diagram.edit.parts.DecisionIDEditPart) childEditPart)
	...
	*/
	 ...
	 * @generated
	 */
	public class DecisionFigure extends RoundedRectangle {
