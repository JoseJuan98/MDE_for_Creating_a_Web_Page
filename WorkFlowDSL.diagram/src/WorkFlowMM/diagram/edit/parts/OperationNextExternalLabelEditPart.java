 ...
 * @generated
 */
public class OperationNextExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
				.getType(WorkFlowMM.diagram.edit.parts.OperationNextExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public OperationNextExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new WorkFlowMM.diagram.edit.policies.WorkFlowMMTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.OperationNext_4001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					WorkFlowMM.diagram.edit.parts.WorkFlowMMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new OperationNextExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OperationNextExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OperationNextExternalLabelFigure() {
			this.setText("name");
		}
