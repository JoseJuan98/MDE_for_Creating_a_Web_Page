 ...
 * @generated
 */
public class InitialNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InitialNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.Initial_3019, getParserElement(),
					WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
							.getType(WorkFlowMM.diagram.edit.parts.InitialNameEditPart.VISUAL_ID));
		}
		return parser;
	}
