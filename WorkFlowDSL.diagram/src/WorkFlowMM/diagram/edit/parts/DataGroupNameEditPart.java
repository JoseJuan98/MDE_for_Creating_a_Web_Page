 ...
 * @generated
 */
public class DataGroupNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataGroupNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.DataGroup_3010, getParserElement(),
