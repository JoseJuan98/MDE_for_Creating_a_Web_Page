 ...
 * @generated
 */
public class DateNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DateNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WorkFlowMM.diagram.providers.WorkFlowMMParserProvider.getParser(
					WorkFlowMM.diagram.providers.WorkFlowMMElementTypes.Date_3017, getParserElement(),
