 ...
 * @generated
 */
public class ActorActorDataCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkFlowMM.WorkFlowMMPackage.eINSTANCE.getActor_Data();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getActorActorDataCompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return WorkFlowMM.diagram.edit.parts.DataGroupEditPart.VISUAL_ID == WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getActorActorDataCompartment_7003SemanticChildren((View) getHost().getModel());
