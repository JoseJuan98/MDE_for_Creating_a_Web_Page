 ...
 * @generated
 */
public class DataGroupDataGroupDataCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkFlowMM.WorkFlowMMPackage.eINSTANCE.getDataGroup_Data();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getDataGroupDataGroupDataCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		int visualID = WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getDataGroupDataGroupDataCompartment_7002SemanticChildren((View) getHost().getModel());
