 ...
 * @generated
 */
public class ActorActorOperationsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkFlowMM.WorkFlowMMPackage.eINSTANCE.getActor_Operations();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getActorActorOperationsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getActorActorOperationsCompartment_7001SemanticChildren((View) getHost().getModel());
