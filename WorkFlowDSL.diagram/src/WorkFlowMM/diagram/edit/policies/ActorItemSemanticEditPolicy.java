 ...
 * @generated
 */
public class ActorItemSemanticEditPolicy extends WorkFlowMM.diagram.edit.policies.WorkFlowMMBaseItemSemanticEditPolicy {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case WorkFlowMM.diagram.edit.parts.InitialEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									incomingLink) == WorkFlowMM.diagram.edit.parts.OperationNextEditPart.VISUAL_ID) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									incomingLink) == WorkFlowMM.diagram.edit.parts.SendMsgNavigatesToEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									outgoingLink) == WorkFlowMM.diagram.edit.parts.OperationNextEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
					...
					case WorkFlowMM.diagram.edit.parts.SendMsgEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									outgoingLink) == WorkFlowMM.diagram.edit.parts.SendMsgAttachSendEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									outgoingLink) == WorkFlowMM.diagram.edit.parts.SendMsgNavigatesToEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case WorkFlowMM.diagram.edit.parts.ReceiveMsgEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									outgoingLink) == WorkFlowMM.diagram.edit.parts.ReceiveMsgAttachRecEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case WorkFlowMM.diagram.edit.parts.ServiceTaskEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									outgoingLink) == WorkFlowMM.diagram.edit.parts.ServiceTaskRequiresEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
					...
					case WorkFlowMM.diagram.edit.parts.UserTaskEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									outgoingLink) == WorkFlowMM.diagram.edit.parts.UserTaskInputEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(), null,
										outgoingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case WorkFlowMM.diagram.edit.parts.DataGroupEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									incomingLink) == WorkFlowMM.diagram.edit.parts.ServiceTaskRequiresEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									incomingLink) == WorkFlowMM.diagram.edit.parts.UserTaskInputEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									incomingLink) == WorkFlowMM.diagram.edit.parts.SendMsgAttachSendEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
							...
							if (WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry.getVisualID(
									incomingLink) == WorkFlowMM.diagram.edit.parts.ReceiveMsgAttachRecEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(), null,
										incomingLink.getTarget().getElement(), false);
								cmd.add(new DestroyReferenceCommand(r));
