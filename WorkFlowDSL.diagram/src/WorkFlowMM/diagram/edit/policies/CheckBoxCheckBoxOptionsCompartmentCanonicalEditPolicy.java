 ...
 * @generated
 */
public class CheckBoxCheckBoxOptionsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return WorkFlowMM.WorkFlowMMPackage.eINSTANCE.getCheckBox_Options();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getCheckBoxCheckBoxOptionsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return WorkFlowMM.diagram.edit.parts.OptionEditPart.VISUAL_ID == WorkFlowMM.diagram.part.WorkFlowMMVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WorkFlowMM.diagram.part.WorkFlowMMNodeDescriptor> childDescriptors = WorkFlowMM.diagram.part.WorkFlowMMDiagramUpdater
				.getCheckBoxCheckBoxOptionsCompartment_7004SemanticChildren((View) getHost().getModel());
