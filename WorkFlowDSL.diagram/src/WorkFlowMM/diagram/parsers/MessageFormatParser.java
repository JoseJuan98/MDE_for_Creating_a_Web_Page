 ...
 * 
 */
package WorkFlowMM.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(WorkFlowMM.diagram.part.WorkFlowMMDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(WorkFlowMM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
