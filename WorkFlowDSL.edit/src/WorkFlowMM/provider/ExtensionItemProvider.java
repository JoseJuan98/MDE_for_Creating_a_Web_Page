...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.Extension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_extension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_extension_feature", "_UI_Extension_type"),
				 WorkFlowMMPackage.Literals.EXTENSION__EXTENSION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Extension)object).getExtension();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Extension.class)) {
			case WorkFlowMMPackage.EXTENSION__EXTENSION:
