...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.File} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FileItemProvider extends DataItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkFlowMMPackage.Literals.FILE__EXTENSION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(File.class)) {
			case WorkFlowMMPackage.FILE__EXTENSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkFlowMMPackage.Literals.FILE__EXTENSION,
				 WorkFlowMMFactory.eINSTANCE.createExtension()));
	}
