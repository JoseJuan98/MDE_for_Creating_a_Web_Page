...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.CheckBox} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckBoxItemProvider extends DataItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkFlowMMPackage.Literals.CHECK_BOX__OPTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CheckBox.class)) {
			case WorkFlowMMPackage.CHECK_BOX__OPTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkFlowMMPackage.Literals.CHECK_BOX__OPTIONS,
				 WorkFlowMMFactory.eINSTANCE.createOption()));
	}
