...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.Range} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RangeItemProvider extends DataItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Range_minValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Range_minValue_feature", "_UI_Range_type"),
				 WorkFlowMMPackage.Literals.RANGE__MIN_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addMaxValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Range_maxValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Range_maxValue_feature", "_UI_Range_type"),
				 WorkFlowMMPackage.Literals.RANGE__MAX_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Range.class)) {
			case WorkFlowMMPackage.RANGE__MIN_VALUE:
			case WorkFlowMMPackage.RANGE__MAX_VALUE:
