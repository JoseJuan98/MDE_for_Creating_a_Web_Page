...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkFlowMMPackage.Literals.DATA__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRequieredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_requiered_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_requiered_feature", "_UI_Data_type"),
				 WorkFlowMMPackage.Literals.DATA__REQUIERED,
				 true,
				 false,
				 false,
