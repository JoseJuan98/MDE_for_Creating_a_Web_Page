...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.WorkFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkFlowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkFlowMMPackage.Literals.WORK_FLOW__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkFlowMMPackage.Literals.WORK_FLOW__ACTORS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WorkFlow.class)) {
			case WorkFlowMMPackage.WORK_FLOW__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WorkFlowMMPackage.WORK_FLOW__ACTORS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkFlowMMPackage.Literals.WORK_FLOW__ACTORS,
				 WorkFlowMMFactory.eINSTANCE.createActor()));
	}
