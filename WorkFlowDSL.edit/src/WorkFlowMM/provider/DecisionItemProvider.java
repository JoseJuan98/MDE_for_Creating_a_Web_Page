...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.Decision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecisionItemProvider extends OperationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_question_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_question_feature", "_UI_Decision_type"),
				 WorkFlowMMPackage.Literals.DECISION__QUESTION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Decision.class)) {
			case WorkFlowMMPackage.DECISION__QUESTION:
