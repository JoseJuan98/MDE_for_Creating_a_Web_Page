...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkFlowMMPackage.Literals.OPERATION__ID,
				 true,
				 false,
				 false,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_next_feature", "_UI_Operation_type"),
				 WorkFlowMMPackage.Literals.OPERATION__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Operation.class)) {
			case WorkFlowMMPackage.OPERATION__ID:
