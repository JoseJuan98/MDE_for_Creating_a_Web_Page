...
/**
 * This is the item provider adapter for a {@link WorkFlowMM.Option} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Option_fieldname_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Option_fieldname_feature", "_UI_Option_type"),
				 WorkFlowMMPackage.Literals.OPTION__FIELDNAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Option)object).getFieldname();
